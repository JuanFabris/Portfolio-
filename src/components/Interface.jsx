        ...
        <Section>
            ...
            <motion.p className='rounded text-xl text-white mt-3 font-mono font-semibold'
                ...
                {isMobile ? (
                    ...
                    <>
                        I hold a degree in Criminology and a Certification in Cybersecurity, <br />
                        followed by a six-month coding program and R&D experience at BigRock, HFarm. <br />
                        I consider myself as a Frontend Developer and have recently <br />
                ...
                {isMobile && (
                    <div className="flex justify-center mt-8 space-x-4">
                        <a href="https://www.linkedin.com/in/gianluigi-lucca-fabris-b42385237" target="_blank" rel="noopener noreferrer">
                            <button className='text-white flex-1 flex items-center justify-center'>
